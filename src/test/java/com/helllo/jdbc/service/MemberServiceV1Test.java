...
import com.helllo.jdbc.repository.MemberRepositoryV1;
...
class MemberServiceV1Test {
    ...
    void 이체_오류() throws SQLException {
        ...
        Assertions.assertThat(findMemberA.getMoney()).isEqualTo(5000); // A의 잔고만 줄어들어 비즈니스 로직의 원자성이 깨짐
